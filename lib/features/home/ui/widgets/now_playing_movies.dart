...
class NowPlayingMovies extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        RowTextButton(text: 'Now Playing', onPressed: () {}),
        BlocBuilder<HomeCubit, HomeState>(
          buildWhen:
              (previous, current) =>
                  current is SuccessNowPlaying ||
                  current is ErrorNowPlaying ||
                  current is LoadingNowPlaying,
          builder: (context, state) {
            ...
            } else if (state is ErrorNowPlaying) {
              return Center(
